...
import interpreteur.as.Objets.interfaces.Iterable;
...
public class Liste implements Iterable<Object> {
    ...
    public interpreteur.as.Objets.Liste ajouterTout(interpreteur.as.Objets.Liste elements) {
    ...
    public interpreteur.as.Objets.Liste remplacer(int idx, ASObjet<?> valeur) {
        this.valeur.set(idxRelatif(this.valeur, idx), valeur);
        aucuneClefDuplique();
        return this;
    }

    public interpreteur.as.Objets.Liste remplacer(ASObjet<?> valeur, ASObjet<?> remplacement) {
        this.valeur.replaceAll(v -> v.equals(valeur) ? remplacement : v);
        aucuneClefDuplique();
        return this;
    }

    public interpreteur.as.Objets.Liste remplacerRange(int debut, int fin, interpreteur.as.Objets.Liste remplacement) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof interpreteur.as.Objets.Liste liste)) return false;
    ...
    public static class SousListe extends interpreteur.as.Objets.Liste {
        private final interpreteur.as.Objets.Liste parent;

        SousListe(interpreteur.as.Objets.Liste parent, int debut, int fin) {
            super(parent.valeur.subList(debut, fin).toArray(ASObjet<?>[]::new));
            this.parent = parent;
        }

        public interpreteur.as.Objets.Liste getParent() {
            return parent;
        }
    }
}
